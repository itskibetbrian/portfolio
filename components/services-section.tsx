  ...
  const services = [
    {
      ...
      description: "Building performant, accessible, and scalable web applications using modern frameworks like Next.js and React.",
      image: "/images/web-design.svg",
    },
    {
      title: "Mobile Development",
      description: "Creating cross-platform mobile applications with clean architecture and seamless user experiences.",
      image: "/images/ui-ux-design.svg",
    },
    {
      title: "API & Backend",
      description: "Designing robust RESTful and GraphQL APIs with secure authentication, rate limiting, and high availability.",
      image: "/images/product-design.svg",
    },
    {
      title: "System Architecture",
      description: "Architecting scalable distributed systems that handle high concurrency and ensure 99.9% uptime.",
      image: "/images/user-research.svg",
    },
    {
      title: "Performance Optimization",
      description: "Tuning applications for speed and efficiency — achieving perfect Lighthouse scores and sub-second load times.",
