...
export function Footer() {
  return (
    <footer className="bg-black dark:bg-neutral-950 border-t-2 border-transparent dark:border-neutral-800 text-white py-12 md:py-16 transition-colors">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          <ScrollAnimate variant="fade-up">
            <div className="mb-10 md:mb-12 relative">
              <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                <div className="w-24 h-24 md:w-36 md:h-36 rounded-full flex items-center justify-center flex-shrink-0 relative overflow-hidden">
                  <Image
                ...
                <div className="w-full flex-1 bg-white dark:bg-neutral-900 border-4 border-black dark:border-neutral-700 rounded-3xl py-4 px-4 md:py-6 md:px-8 flex flex-col md:flex-row items-center gap-4 md:gap-6">
            ...
            {socialLinks.map((link) => (
              <StaggerItem key={link.name}>
                <a
                  ...
                  className="inline-flex items-center gap-3 py-2.5 px-4 border-[3px] border-black dark:border-white rounded-[12px] bg-white dark:bg-neutral-900 text-black dark:text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.15)] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.25)] active:translate-y-[2px] active:shadow-none transition-all"
                >
