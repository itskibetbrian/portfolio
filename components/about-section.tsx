      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="pt-2 pb-4">
            <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4" staggerDelay={0.04}>
              {toolboxItems.map((item, index) => (
                <StaggerItem key={`${item.title}-${index}`}>
                  <div
                    className="inline-flex items-center gap-3 py-2.5 px-3 border-[3px] border-black dark:border-white rounded-[12px] bg-white dark:bg-neutral-900 text-black dark:text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.15)] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.25)] active:translate-y-[2px] active:shadow-none transition-all"
                  >
